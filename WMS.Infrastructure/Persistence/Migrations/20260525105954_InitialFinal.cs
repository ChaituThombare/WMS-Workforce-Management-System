        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientPhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Regular Employee", "Employee" }
                });

            migrationBuilder.InsertData(
                table: "UserLogins",
                columns: new[] { "UserId", "EmployeeId", "LastLogin", "PasswordHash", "RoleId", "Username" },
                values: new object[] { 1, null, null, "6G94qKPK8LYNjnTllCqm2G3BUM08AzOK7yW30tfjrMc=", 1, "admin" });
